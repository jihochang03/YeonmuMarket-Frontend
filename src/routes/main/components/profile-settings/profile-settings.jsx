...
export const ProfileSettings = () => {
  ...
  return (
    <div className="min-h-main-menu-height rounded-md mt-4 mx-6 flex flex-col">
      <div className="w-full flex flex-col border-2 border-gray-300 rounded-md justify-center items-center p-4">
